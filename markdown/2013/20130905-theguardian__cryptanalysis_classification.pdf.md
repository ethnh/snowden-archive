...
## CLASSIFIED BY: <br> REASON FOR CLASSIFICATION: 1.4 (c) DECLASSIFY ON: 20291123
...
| 5. (TS//SI) The fact that NSA/CSS makes cryptographic modifications to commercial or indigenous cryptographic information security devices or systems in order to make them exploitable. | TOP SECRET// <br> COMINT <br> at a minimum | $1.4(\mathrm{c})$ | 20291123 | (U) Specifying the specific system is protected by an ECI. |
